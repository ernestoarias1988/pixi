 ...
 * Class Google_sync
 *
 * This class implements all the core synchronization between the Google Calendar and the Pixi system.
 *
...
class Google_sync {
     ...
     * where the user grants access to his data for the Pixi app.
     */
     ...
     * when the provider granted consent to Pixi for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of Pixi
     ...
     * provided appointment record of Pixi.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
