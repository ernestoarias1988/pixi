 ...
 * Class Console
 *
 * CLI commands of Pixi, can only be executed from a terminal and not with a direct request.
 */
class Console extends EA_Controller {
     ...
     *
     * Use this method to install Pixi directly from the terminal.
     *
     * Usage:
     *
     ...
     *
     * Use this method to backup your Pixi data.
     *
     * Usage:
     *
     ...
     *
     * Use this method in a cronjob to automatically sync events between Pixi and Google Calendar.
     *
     * Notice:
     *
