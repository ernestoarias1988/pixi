...
$lang['about_app_info'] = 'Pixi ist eine extrem anpassungsfähige Internet-Applikation die es Ihren Kunden ermöglicht, einen Termin mit Ihnen über des Internet zu schließen. Darüberhinaus gibt es Ihnen die Möglichkeit Ihre Daten mit dem Google Kalender zu synchronisieren, so dass Sie diese mit anderen Dienstleistungsprogrammen nutzen können.';
$lang['current_version'] = 'Laufende Version';
$lang['support'] = 'Unterstützung';
$lang['about_app_support'] = 'Falls Sie irgendein Problem bei der Nutzung von Pixi haben sollten können Sie die offizielle Google Gruppe nach Lösungen durchsuchen. Sie können auch ein neues Thema in Google Code beginnen, damit Sie die Findung von Lösungen unterstützen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ist lizensiert under der GPLv3-Lizenz. Bei Benutzung des Codes für Pixi auf irgendeine Weise stimmen Sie mit den Nutzungsbedingungen zu wie sie in folgender url aufgeführt sind:';
...
$lang['ea_update_success'] = 'Pixi wurde erfolgreich aktualisiert.';
...
$lang['api_token_hint'] = 'Setze einen geheimen Token um die tokenbasierte Authentifizierung für die Pixi API zu aktivieren.';
