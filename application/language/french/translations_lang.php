...
$lang['about_app'] = 'Au sujet d\'Pixi';
...
$lang['about_app_info'] = 'Pixi est une application Web hautement personnalisable qui permet à vos clients de prendre rendez-vous avec vous via le web. En outre, elle offre la possibilité de synchroniser vos données avec un calendrier Google afin que vous puissiez les utiliser avec d\'autres services. Pixi est un projet open source et vous pouvez le télécharger et l\'installer même pour un usage commercial. Pixi fonctionnera sans problème avec votre site web existant car il peut être installé dans un dossier spécifique du serveur et bien sûr, les deux sites peuvent partager la même base de données.';
...
$lang['about_app_license'] = 'Pixi est enregistré sous licence GPLv3. En utilisant le code d\'Pixi, quelqu\'en soit l\'usage, vous êtes tenu d\'accepter les termes décrits dans l\'URL suivante:';
...
$lang['ea_update_success'] = 'Pixi à été mis à jour avec succès .';
